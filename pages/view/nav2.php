...
<body>
    ...
    <div class="components-box am-container am-margin-bottom">
        ...
        <h1>简单导航</h1>
        <h3>大图标</h3>
        <ul class="jz-nav jz-nav-icon1">
            <li><a href="">
                <span class="jz-item-icon"><img src="../../img/temp/component/nav-img1.png" alt=""/></span>
                <div class="jz-item-txt">商品<span class="jz-right-icon"></span></div>
            </a></li>
            <li><a href="">
                <span class="jz-item-icon"><img src="../../img/temp/component/nav-img1.png" alt=""/></span>
                <div class="jz-item-txt">商品<span class="jz-right-icon"></span></div>
        ...
        <!-- 图标类型导航2 -->
        <h3>小图标</h3>
        <ul class="jz-nav jz-nav-icon2">
            <li><a href="">
                    <span class="jz-item-icon"><img src="../../img/temp/component/nav-img1.png" alt=""/></span>
                    <div class="jz-item-txt">商品<span class="jz-right-icon"><i class="am-icon-angle-right"></i></span></div>
                </a></li>
            <li><a href="">
                    <span class="jz-item-icon"><img src="../../img/temp/component/nav-img1.png" alt=""/></span>
                    <div class="jz-item-txt">商品<span class="jz-right-icon"><i class="am-icon-angle-right"></i></span></div>
        ...
        <ul class="jz-nav jz-nav-icon2">
            <li><a href="">
                <span class="jz-item-icon"><i class="am-icon-home"></i></span>
                <div class="jz-item-txt">商品<span class="jz-right-icon"><i class="am-icon-angle-right"></i></span></div>
            </a></li>
            <li><a href="">
                <span class="jz-item-icon"><i class="am-icon-home"></i></span>
        ...
        <!-- 图标类型导航2 -->
        <h3>简单介绍信息</h3>
        <ul class="jz-nav jz-nav-icon3">
            <li><a href="">
                <span class="jz-item-icon"><img src="../../img/temp/component/nav-img1.png" alt=""/></span>
                <div class="jz-item-txt">商品<span class="jz-right-icon"><i class="am-icon-angle-right"></i></span>
                    <p class="jz-item-explain">简单介绍</p>
                </div>
            </a></li>
            <li><a href="">
                <span class="jz-item-icon"><img src="../../img/temp/component/nav-img1.png" alt=""/></span>
        ...
        <ul class="am-nav">
            ...
            <li class="am-dropdown" data-am-dropdown>
                <a class="am-dropdown-toggle" href="javascript:;">下拉
        ...
        <ul class="am-nav am-nav-pills">
            ...
            <li><a href="#">开始使用</a></li>
            <li class="am-dropdown" data-am-dropdown>
                <a class="am-dropdown-toggle" href="javascript:;">下拉<i class="am-icon-caret-down"></i></a>
                <ul class="am-dropdown-content">
                    <li><a href="#">下拉条目</a>
                    <li><a href="#">下拉条目</a>
                    <li><a href="#">下拉条目</a>
        ...
        <ul class="am-nav am-nav-pills am-nav-justify">
			<li class="am-dropdown" data-am-dropdown="">
				<a class="am-dropdown-toggle" href="javascript: void(0)">
					新闻
					<i class="am-icon-caret-down">
					</i>
				</a>
				<ul class="am-dropdown-content">
					<li>
        ...
        <h2>横排</h2>
        <h3>default</h3>
        <nav data-am-widget="menu" class="am-menu  am-menu-default" data-am-menu-collapse>
        ...
        <style>
            .am-menu-toggle-icon, .am-menu-toggle-title {
                color: #333;
            }
        </style>
    </div>
